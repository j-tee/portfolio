...
export const projects = [
  {
    ...
    description: `A web app developed using HTML, CSS, and JavaScript to demonstrate responsive design 
  ...
  },
  {
    ...
    description: `A simple web app built with HTML, CSS, and JavaScript, It displays a list of books and allows 
  ...
  },
  {
    ...
    description: `The application demonstrates the use of modules in JavaScript to access the following API 
  ...
  },
  {
    ...
    description: 'A simple web app built in HTML, CSS, and JavaScript that stores a list of to-do tasks in local storage.',
  ...
  },
  {
    id: 'doctors',
    name: 'Doctors',
    summary: 'A Client/Server Application that uses ReactJS for the front-end and Ruby for the backend API',
    featured: ['TeeJay', 'Lead Developer', 2015],
    description: `A web app that allows users to book the services of a doctor. 
    Users can view a list of doctors and schedule an appointment, and Add and delete a doctor. 
    The project is a collaboration in a remote environment using pair programming. 
    The application showcases a client/server architecture with the server being a Ruby API and the client, a react project`,
